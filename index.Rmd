...
.pull-left[
```{r, echo=FALSE,out.width="350px",  out.height="600px",fig.cap="Esse é o Hemílio.",fig.show='hold',fig.align='center'}
...
.pull-right[
```{r, echo=FALSE,out.width="300cm",  out.height="600px",fig.cap="Esse é o Batman.",fig.show='hold',fig.align='center'}
